...
const Loader = {
  ...
  hide: function(sec) {
    if(!CONFIG.loader.start)
      sec = -1
    this.timer = setTimeout(this.vanish, sec||2000);
  },
  vanish: function() {
    if(Loader.lock)
      return;
